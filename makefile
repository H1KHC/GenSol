...
bin/gensol: .build/src\access.cpp.release.o \
 .build/src\debugOutput.cpp.release.o \
 ...
 .build/src\variables.cpp.release.o
	g++ $^ -lboost_filesystem-mt -lboost_program_options-mt -lboost_system-mt -static-libgcc -std=c++11 -o $@

bin/gensold: .build/src\access.cpp.debug.o .build/src\debugOutput.cpp.debug.o \
 .build/src\generate.cpp.debug.o \
...
# Targets:
bin/gensol: .build/src/access.cpp.release.o .build/src/debugOutput.cpp.release.o .build/src/error.cpp.release.o .build/src/generate.cpp.release.o .build/src/help.cpp.release.o .build/src/init.cpp.release.o .build/src/loadAndParse.cpp.release.o .build/src/main.cpp.release.o .build/src/matchFiles.cpp.release.o .build/src/merge.cpp.release.o .build/src/solution.cpp.release.o .build/src/variables.cpp.release.o
	g++ $^ -lboost_filesystem -lboost_program_options -lboost_system -static-libgcc -std=c++11 -o $@
...
clean:
	rm -rf .build/ .build/src bin/ bin/gensol bin/gensold
>>>>>>> 6104e94bb26c1172afea4e4e4af5721f5aa0a930
